...
const ResCard = ({ data }) => {
  ...
  return (
    <div className="bg-slate-500 m-3 p-2 w-60 rounded-lg font-semibold hover:cursor-pointer h-[350px] border-black border-4 hover:bg-orange-500 shadow-2xl shadow-slate-600">
